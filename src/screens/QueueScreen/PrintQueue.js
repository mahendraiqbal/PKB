...
const PrintQueue = ({ navigation }) => {
    const data = [
        { id: '1', noAntrian: '001', noKendaraan: 'ABCDE123', posisi: 'Cetak', keterangan: 'Uji Berkala' },
        { id: '2', noAntrian: '002', noKendaraan: 'FGHIJ456', posisi: 'Penyerahan', keterangan: 'Uji Berkala' },
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subTitle}>Daftar Antrian Cetak</Text>
