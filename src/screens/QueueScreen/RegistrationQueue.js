...
const RegistrationQueueScreen = ({ navigation }) => {
    const data = [
        { id: '1', noAntrian: '001', noKendaraan: 'ABCDE123', posisi: 'A1', keterangan: 'Uji Berkala' },
        { id: '2', noAntrian: '002', noKendaraan: 'FGHIJ456', posisi: 'B2', keterangan: 'Uji Berkala' },
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subTitle}>Daftar Antrian Pendaftaran</Text>
...
export default RegistrationQueueScreen;
