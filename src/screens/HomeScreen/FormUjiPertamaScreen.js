...
const FormUjiPertamaScreen = ({ navigation, route }) => {
    ...
    const handleKelurahanChange = (value) => {
        console.log('Selected Kelurahan:', value);
                ...
                >
                    ...
                    <View style={styles.mainCard}>
                        ...
                        <View style={styles.kecamatanCard}>
                            ...
                            <RNPickerSelect
                                placeholder={{ label: 'Select Kecamatan', value: '' }}
                        ...
                        <View style={styles.kecamatanCard}>
                            ...
                            <RNPickerSelect
                                placeholder={{ label: 'Select Kelurahan', value: '' }}
                        ...
                        <View style={styles.cameraCard}>
                            <Text style={styles.formTitle}>Foto KTP</Text>
                        ...
                        <View style={styles.cameraCard}>
                            <Text style={styles.formTitle}>Foto SRUT</Text>
                            {hasCameraPermission === null ? (
                                <View />
                            ) : hasCameraPermission === false ? (
                                <Text>No access to camera</Text>
                            ...
                            {isCameraOpenSRUT && (
                                ...
                                >
                                    <Text style={styles.captureButtonText}>Capture Photo SRUT</Text>
                                </TouchableOpacity>
                            )}
...
export default FormUjiPertamaScreen;