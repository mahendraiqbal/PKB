...
const FormUjiBerkala = ({ navigation, route }) => {
    ...
    const generateQRCode = () => {
        ...
        const combinedData = `${noKendaraanAB}${noKendaraanAngka}${noKendaraanHuruf}${noRangka}${namaPemilik}${capturedPhoto}${selectedDate}${selectedMerk}${alamat}${selectedJenisKen}${selectedTipe}`;
            ...
            >
                ...
                >
                    ...
                    <View style={styles.header}>
                        ...
                        <Text style={styles.headerTitle}>Permohonan Uji Berkala</Text>
                    </View>
